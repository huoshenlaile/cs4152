#ifndef __TD_CAMERA_CONTROLLER_H__
#define __TD_CAMERA_CONTROLLER_H__
...
#pragma mark Constructors
    ...
    */
    ...
    static std::shared_ptr<CameraController> alloc(const std::shared_ptr<cugl::scene2::SceneNode> target, const std::shared_ptr<cugl::scene2::SceneNode> root, float lerp, std::shared_ptr <cugl::OrthographicCamera> camera, std::shared_ptr<scene2::SceneNode> ui, float maxZoom) {
